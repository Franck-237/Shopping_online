...
const ImageList = [ 
    { 
        ...
        description: "lorem His Life will be changed dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    },
    { 
        id: 2,
        img: image2,
...
const Hero = ({handlerOrderPopup}) => {
  ...
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200"> 
        ...
        <div className="container px-2 pb-8 sm:pb-0">
            <Slider {...settings}>
                {
                    ImageList.map((data) => (
                        <div 
