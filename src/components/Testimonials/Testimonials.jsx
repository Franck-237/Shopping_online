...
const TestimonialData = [ 
    {
        id: 1,
        name: "Victor",
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa laboriosam, totam sed voluptatem ratione nihil quae quos possimus praesentium blanditiis vel, asperiores quia fugit ea eos, expedita provident corrupti incidunt.",
               ...
               <Slider {...settings}>
                    { 
                        TestimonialData.map((data) => (
                          ...
                          className="my-6">
                            <div 
                            className="flex flex-col gap-6 shadow-lg py-8 px-6 mx-4 rounded-xl dark:bg-gray-800 bg-primary/10 relative"
                            >
                                <div className="">
